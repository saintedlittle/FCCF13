...
screen main_menu():
    ...
    imagemap:
        ground "00-ZhMa-novella/00-Menu/Menu-background.png"
        idle "00-ZhMa-novella/00-Menu/Buttons.png"
        hover "00-ZhMa-novella/00-Menu/Buttons-backlit.png"

        hotspot(50, 270, 580, 180) action Start()
        hotspot(44, 466, 521, 141) action ShowMenu("load")
        hotspot(30, 612, 535, 170) action ShowMenu("preferences")
        hotspot(40, 785, 419, 160) action ShowMenu("about")
        hotspot(0, 959, 264, 121) action Quit(confirm=True)
        hotspot(1645, 955, 275, 125) action ShowMenu("help")
