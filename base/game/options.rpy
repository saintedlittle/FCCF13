...
define gui.about = _p("""
Спасибо за прохождение нашей новеллы One day!
Познакомится с нами поближе вы сможете по ТГК FccF13
https://t.me/FccF13

Треки использованные в новелле

Мурка убирается
SharaX Battle Against A True Hero (SoundCloud)

Мурка читает
SharaX -
Goodbye To A World (SoundCloud)

Звонок Мурки
Xandu - Stronger Than You
- Genocide Remix (SoundCloud)

Звонок Нюши
Undertale - Megalovania METAL Ver. - Caleb Hyles (SoundCloud)

Вход на дискотеку
DISCOTEK Rooler (Яндекс музыка)
Tricky Disco 2k10 (Яндекс музыка)
ROMANCEPLANET (SoundCloud)

Выход на улицу к лантеру
Nokia Lumia Live ft deadmau5 lights up London with amazing... (SoundCloud)

Бар лантера
Massano - The Feeling Running Clouds (SoundCloud)

Пьяная дорога домой в одиночестве
Feralcat FccF (На всех платформах)

Автор FccF (На канале)

Меню
SNA FccF (Недоступно)

Концовка Мурка выжила
By the seashore (Without words) (SNA) FccF (Недоступно)

Данная новелла является демо версией, так что до встречи в следующей новелле!
...
define config.main_menu_music = "music/00-SNA.ogg"
...
define config.save_directory = "OD-1732049264"
